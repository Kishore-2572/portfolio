  ...
  return (
    <section id="portfolio">
      ...
      <article className="portfolio-item">
          ...
          <h3>Salon online appointment booking website (MERN stack)</h3>
          <div className="portfolio-item-cta">
            <a href="https://github.com/Kishore-2572/salon-booking" className='btn'  target='_blank' >Github</a>
            <a href="https://zrog.onrender.com/" className='btn btn-primary' target='_blank' >Live Demo</a>
          </div>
        </article>
        <article className="portfolio-item">
          <div className="portfolio-item-img">
          ...
          <h3>An simple ecommerce website  (MERN stack)</h3>
          <div className="portfolio-item-cta">
        ...
        <article className="portfolio-item">
          ...
          <h3>It is mobile application developed for my college (Flutter)</h3>
          <div className="portfolio-item-cta">
